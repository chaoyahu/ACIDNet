...
eval_parser.add_argument('--SID', action='store_true',default='True')
...
if __name__ == '__main__':
    ...
    if ep.Blur:
        for index in range(1,257):
            ...
            model_path = "./experiments/weights/lolv2/ours_2r_24.26_final.pth"
            blur_folder = "./outputs/generated/LOL_Blur/"
        ...
        for index in range(1,230):
            ...
            now_dir = test_dir + fill_index + "/"
            model_path = "./experiments/weights/SID/ours_SID_22.91.pth"
            SID_folder = "./outputs/generated/SID/"
